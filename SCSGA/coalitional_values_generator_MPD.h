...
class coalitional_values_generator_MPD : public coalitional_values_generator
{
public:
	coalitional_values_generator_MPD();
...
private:
	...
	std::normal_distribution<coalition::value_t> nrd_generator, nsd_generator, error_generator;
